...
const AutomaticBookingForm = () => {
  ...
  const calcRoute = () => {
    ...
    if (!start || !end) {
      value_distance.innerHTML = "Press on the Booking button to calculate...";
      value_price.innerHTML = "Press on the Booking button to calculate...";
      return;
    }
    ...
    <div className="container">
      <div className="row">
        <form id="form" className="col-sm-8">
          ...
          <button id="submit" type="submit" className="btn btn-primary" onClick={calcRoute}>Submit</button>
        </form>
        <div id="form" className="form-horizontal col-sm-4">
          <div className="form-group">
            <b><label htmlFor="to-input">Distance</label></b>
            <label id="value-distance" className="form-text">Press on the Booking button to calculate...</label>
          </div>
          <div className="form-group">
            <b><label htmlFor="to-input">Price per KM</label></b>
            <label id="price" className="form-text">5 USD</label>
          </div>
          <div className="form-group">
